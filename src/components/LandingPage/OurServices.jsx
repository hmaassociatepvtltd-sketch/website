  ...
  return (
    <section style={{
     ...
     <div className="absolute inset-0 bg-gradient-to-t from-black/90 to-transparent z-10"></div>
      ...
      <div className="max-w-[1260px] mx-auto px-4 py-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 py-4">
          {servicesData.map((service, index) => (
            <div key={service.id} className="group relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden hover:shadow-2xl hover:shadow-blue-900/20 transition-all duration-300 hover:-translate-y-1.5">
