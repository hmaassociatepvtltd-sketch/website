            ...
            <div className={`w-full px-5 xl:px-0 z-10 h-full items-end xl:items-center py-10 grid grid-cols-1 xl:grid-cols-2 inset-0 max-w-[1260px] ${ props?.description ? 'min-h-[80vh]' : 'min-h-[50vh]' } `}>
                <div className={'flex flex-col gap-5 max-w-[700px]'}>
                    <h1
                        ...
                        className={'text-white uppercase col-span-1 font-josefin-sans font-bold text-6xl xl:text-7xl tracking-tighter'}
                    >
                        {props?.title}
                    </h1>
                    <p
                        data-tina-field={tinaField(props, 'description')}
                        className={'text-white col-span-1 font-poppins text-lg opacity-75 tracking-normal'}
                    >
                        {props?.description}
                    </p>
                    {props?.buttonText && (
