...
blocks:
  - sectionHeading: ''
    slideDuration: 10000
    slides:
      - slideHeading: Empowering Communities  with Energy &  Innovations
        subHeading: WELCOME TO HMA Associates (SMC-Private) Limited
        description: ''
        animationType: fade-zoom
        backgroundImage: /23985244_6876539.jpg
        buttonText: Contact Us
        buttonStyle: secondary-glass
        secondaryButtonText: ''
      - slideHeading: MEP Services
        subHeading: 'Safe, efficient, and optimized power distribution solutions'
        ...
        buttonStyle: secondary-glass
        secondaryButtonText: ''
      - slideHeading: Construction Services
        subHeading: 'Modern, functional, and sustainable '
        description: 'Modern, functional, and sustainable '
        animationType: fade-zoom
        backgroundImage: /AdobeStock_290512663-scaled.webp
        buttonText: Contact Us
        buttonStyle: secondary-glass
      - slideHeading: Solar Power Solutions
        subHeading: 'Best Solar Power Solutions for your Home and Business '
        description: 'Get in Touch with Us for efficient and Best Solar Power Solutions '
        animationType: fade-zoom
